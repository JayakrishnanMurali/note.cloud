  ...
  return (
    ...
    "
      ...
      "
        ...
        <div className="justify-self-end order-2 cursor-pointer text-white fixed z-50 sm:right-5 lg:hidden">
          <button className="transition-all" id="menuBtn" onClick={menuToggle}>
